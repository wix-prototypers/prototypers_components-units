...
const editorx_components = [
  ...
  },
  {
    ...
    htmlCode: `<button class="pcu-button pcu-button-affix" size="medium" skin="standard" priority="primary" icon="prefix"><img src="./wsr-icons/add-icon.svg">Prefix</button>`
  },
  {
  ...
  },
  {
    ...
    <img src="./wsr-icons/close-icon.svg">
    </button>`
  },
  {
